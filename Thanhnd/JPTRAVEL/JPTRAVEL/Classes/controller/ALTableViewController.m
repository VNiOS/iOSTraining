...
@synthesize enableLoadMore;
@synthesize enableRefreshHeader;
@synthesize lastNumberItem;

-(void) dealloc{
    //Release properties from memory
...
{
#warning Potentiallncomplete method implementation.
